...
<body>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    if (!empty($image)) {
                                        ...
                                        $imageSrc = $imageFolder . $imageName . '?v=' . filemtime($image[0]); // Append file modification timestamp as query parameter
                                        echo '<div class="success-message" id="successMessage" style="display: none;">Image successfully updated.</div>';
                                        echo '<img class="main-image" src="' . $imageSrc . '" alt="Current Image">';
                                    } else {
                                        echo 'No image found.';
                                    }
                                    ?>
                                ...
                                <div class="card-body">
                                    ...
                                    if (!empty($secondImage)) {
                                        ...
                                        echo '<img class="main-image second-image" src="' . $secondImageFolder . $secondImageName . '" alt="Second Image">';
                                    } else {
                                ...
                                <div class="modal fade" id="updateSecondModal" tabindex="-1" aria-labelledby="updateSecondModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
    ...
    <script>
        var imageFolder = 'imageuploads/'; // Replace with the actual path to your image folder
    </script>
    <script>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response === 'success') {
                            ...
                            var imageSrc = $('#newPhoto').val().split('\\').pop();
                            var updatedImageSrc = imageFolder + imageSrc + '?v=' + Date.now(); // Append a unique query parameter
                            $('.main-image').attr('src', updatedImageSrc);
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response === 'success') {
                            ...
                            $('.second-image').attr('src', secondImageFolder + secondImageSrc);
    ...
    <script>
        var newImageFolder = 'new_image_uploads/';
